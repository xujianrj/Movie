...
<meta name="keywords" content="<?php if(!empty($list_keywords)): ?><?php echo ($list_keywords); ?>
<?php else: ?>
最新<?php echo ($list_name); ?>,<?php echo ($keywords); ?><?php endif; ?>
">
...
<div id="content" class="layout">
  ...
  <div class="bread-crumb-nav fn-clear">
    <ul class="bread-crumbs">
      ...
      <li> 搜索&nbsp;
        <?php if(!empty($search_wd)): ?>&nbsp;<span style="color:#b80a52"><?php echo ($search_wd); ?></span>&nbsp;<?php endif; ?>
        结果</li>
    </ul>
    <!-- // bread-crumbs end -->
  </div>
  ...
  <div class="ui-box ui-qire fn-clear" id="list-focus">
    <div class="qire-box">
      <div class="ui-bar fn-clear">
        <ul class="view-mode">
          <li id="view-list"><a rel="nofollow" class="current" href="#" data="t-2">搜索结果</a></li>
        </ul>
        <!-- view-mode end -->
        <!-- view-filter end -->
      ...
      <ul class="show-list fn-clear" id="contents">
        ...
        <?php if(is_array($vod_list)): $i = 0; $__LIST__ = $vod_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppvod): ++$i;$mod = ($i % 2 )?><li><a class="play-img" target="_blank" href="<?php echo ($ppvod["vod_readurl"]); ?>"><img src="<?php echo ($ppvod["vod_picurl"]); ?>" alt="<?php echo (msubstr($ppvod["vod_name"],0,20)); ?>" />
  ...
  <!-- // ui-sponsor end --><!--模板仿制、修改，QQ：182377860  模板支持网站：www.yayamov.com-->
